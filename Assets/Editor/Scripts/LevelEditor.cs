...

{
    ...
    private void OnGUI()
    {
        ...
        if (GUILayout.Button("*** Clear unity prefs keys ***"))
        {
            LevelsData levelsData = new LevelsData();
            levelsData.Clear();
            LevelIndex index = new LevelIndex();
            index.Clear();
            Debug.LogWarning("Keys was cleared");
        }
        ...
        else
        {
            ...
            {
                FindAnyObjectByType<ClearLevel>().Clear();
                BlocksGeneratorScript blocksGeneratorScript = new BlocksGeneratorScript();
                blocksGeneratorScript.Generate(_gameLevel,_parent);
            }
