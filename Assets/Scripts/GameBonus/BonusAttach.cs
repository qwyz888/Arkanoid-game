...
public class BonusAttach : MonoBehaviour
{
    ...
    [SerializeField] private BoxCollider2D _boxCollier2D;
    ...
    public void SetEnableMoveAndVisible(bool value)
    {
        _boxCollier2D.enabled = value;
